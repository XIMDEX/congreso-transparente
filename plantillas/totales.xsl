...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <xsl:template name="totales" match="Totales">
        <xsl:variable name="titulo">
            <xsl:value-of select="/docxap/Resultado/Informacion/Titulo/text()"/>
        </xsl:variable>
        ...
        <div class="row result">
            ...
            <script type="text/javascript">stLight.options({publisher: "a158aa4b-e5dd-423c-bc02-a6782332d85e", doNotHash: false, doNotCopy: false, hashAddressBar: true});</script>
            <script>
                var dataset = {
        ...
        <div class="right sharethis">
            <span st_title="Congreso transparente: {$titulo}" class="st_facebook_large" displayText="Facebook"/>
            <span st_title="Congreso transparente: {$titulo}" st_via="ximdex" class="st_twitter_large" displayText="Tweet"/>
            <span st_title="Congreso transparente: {$titulo}" class="st_googleplus_large" displayText="Google +"/>
            <span st_title="Congreso transparente: {$titulo}" class="st_linkedin_large" displayText="LinkedIn"/>
            <span st_title="Congreso transparente: {$titulo}" class="st_email_large" displayText="Email"/>
        </div>
    </xsl:template>
</xsl:stylesheet>
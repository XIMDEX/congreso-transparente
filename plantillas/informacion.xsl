        ...
        <div class="row content">
            <div class="col-md-12">
                ...
                <div class="title">
                    ...
                    <div class="subgrupo">
                        <xsl:if test="TituloSubGrupo != ''">
                            <span class="subgrupo-titulo">
                                <xsl:value-of select="TituloSubGrupo"/>
                            </span>
                        </xsl:if>
                        <xsl:if test="TextoSubGrupo != ''">
                            <span class="subgrupo-texto">
                                <xsl:value-of select="TextoSubGrupo"/>
                            </span>
                        </xsl:if>
                    </div>
                </div>
